...
<body>
    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li class="nav-item">
            <a class="nav-link" href="movie page/films.php">Films</a>
          </li>
          <li class="nav-item dropdown">
            <a class="nav-link" href="movie page/series.php">Series</a>
          </li>
        </ul>
        <form class="d-flex" role="search" id="searchForm" action="movie page/search.php" method="get">
  ...
  <div id="blue" class="clearfix"></div>
  <div id="pink" class="clearfix"></div>
  <div class="images">
  <?php  
    ...
    while ($row = $results->fetch()){
      ...
      echo '<div class="'.$cat.' clearfix">
        <a class="main" href="movie page/index.php?id='.$row['id'].'"><img class="fs" src="images/'.$row['image'].'" alt="'.$row['name'].'"></a>
